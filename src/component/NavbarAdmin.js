...
export default function NavbarAdmin() {
  ...
  return (
    <nav className="bg-gray-900 border-gray-200 sticky top-0 z-50 px-2 sm:px-4 py-2.5">
      <div className="container flex flex-wrap justify-between items-center mx-auto">
        ...
        <div className="flex md:order-1">
          <button
            ...
            aria-expanded="false"
            className="md:hidden text-gray-500 text-gray-400 hover:bg-gray-100 hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 focus:ring-gray-700 rounded-lg text-sm p-2.5 mr-1">
            <svg
              className="w-5 h-5"
              aria-hidden="true"
              fill="currentColor"
        ...
        <div
          ...
          <ul className="flex flex-col p-4 mt-4 bg-gray-50 rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-gray-900 md:bg-gray-900 border-gray-700">
            {/* <li>
              <Link
                to={"/"}
            ...
            <li>
              <div className="block py-2 pr-4 pl-3 text-xl text-white">
                Hai, {user.name}
              </div>
            </li>
            <li>
